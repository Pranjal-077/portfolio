...
const Page2 = () => {
  ...
  return (
    <div id="section2" className="bg-white text-center p-10 text-black">
      <h3 className="text-gray-500 text-xl font-[anzo1]">
        © pranjal.studio 2024 | designed and developed
      </h3>
      ...
      <div className="flex items-center justify-center mt-20 scale-75">
      <svg
